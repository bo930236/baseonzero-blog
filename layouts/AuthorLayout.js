        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          <div className="flex flex-col items-center space-x-2 pt-8 xl:sticky xl:top-0">
            ...
            <div className="flex flex-col pt-3">
              <a
                ...
                href="https://twitter.com/messages/compose?recipient_id=1643499801764581376&text=Hey Bobo"
                data-screen-name="@BoZ_baseonzero"
                target="_blank"
          ...
          <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
            <p>
              ...
              >
                {text1} I now work at tri-soaring. {text2}
              </RoughNotation>
            </p>
            <br />
            {/* <p>
            ...
            <p>
              ...
              <Link
                href={'mailto:bo930236@gmail.com'}
                className="special-underline no-underline hover:text-gray-100 dark:text-gray-100 hover:dark:text-gray-900"
              >
                Mail
                <svg
